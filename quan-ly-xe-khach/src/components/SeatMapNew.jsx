...
const SeatMapNew = () => {
  ...
  useEffect(() => {
    ...
    // Theo dõi theo danh sách id (không chỉ length) — chuyển vé giữa 2 chuyến
    // giữ nguyên tổng số vé nhưng id đổi, trước đây list không cập nhật.
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [currentBookings.map(b => b.id).join(',')]);
